...
export const CAR_MODELS = {
  // 날렵한 차 — 빠르게
  race: { file: 'race.glb', speed: 2.2, length: 2.56, lift: 0.3 },
  raceFuture: { file: 'race-future.glb', speed: 2.0, length: 2.66, lift: 0.3 },
  sedanSports: { file: 'sedan-sports.glb', speed: 1.7, length: 2.55, lift: 0.3 },
  hatchbackSports: {
  ...
  police: { file: 'police.glb', speed: 1.5, length: 2.9, lift: 0.3 },

  // 보통
  sedan: { file: 'sedan.glb', speed: 1.0, length: 2.55, lift: 0.3 },
  taxi: { file: 'taxi.glb', speed: 1.0, length: 2.75, lift: 0.3 },
  suv: { file: 'suv.glb', speed: 0.9, length: 2.55, lift: 0.3 },

  // 둔한 차 — 느리게
  ambulance: { file: 'ambulance.glb', speed: 0.7, length: 3.25, lift: 0.3 },
  firetruck: { file: 'firetruck.glb', speed: 0.6, length: 3.25, lift: 0.3 },
  garbageTruck: {
  ...
  tractor: { file: 'tractor.glb', speed: 0.4, length: 1.98, lift: 0.53 },
} as const;
